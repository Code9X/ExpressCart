...
namespace ExpressCartWeb.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    Logging.LogAction(nameof(HomeController), "User created a new account with password.", GetUserId());
        ...
        private ApplicationUser CreateUser() //Added ApplicationUser instead of IdentityUser
        {
            try
            {
